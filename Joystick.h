...
typedef struct {	//Definição da estrutura de um controle (!)
	unsigned int right;		//Botão de movimentação à direta (!)
	unsigned int left;		//Botão de movimentação à esquerda (!)
	unsigned int up;		//Botão de movimentação para cima (!)
	unsigned int down;		//Botão de movimentação para agachar (!)
	unsigned int punch;		//Botão de movimentação para socar (!)
	unsigned int kick;		//Botão de movimentação para chutar (!)																										
...
void joystick_down(joystick *element);		//Protótipo da função de ativação/desativação do botão de movimentação para agachar (!)
void joystick_punch(joystick *element);		//Protótipo da função de ativação/desativação do botão de movimentação para socar (!)
void joystick_kick(joystick *element);		//Protótipo da função de ativação/desativação do botão de movimentação para chutar (!)		
